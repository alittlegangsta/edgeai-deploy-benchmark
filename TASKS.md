...
| 022 | Stage 4 NPU audit | 016 + 021 | Completed | Audit local Anlogic NPU assets, official runtime/one-shot requirements, VM compatibility, and real DR1M90 driver/device state without modifying the board or running unverified NPU code; user-approved audit result is `BLOCKED_DRIVER_OR_DEVICE`, vendor one-shot was not executed, and project YOLOv5n conversion is not ready. |
